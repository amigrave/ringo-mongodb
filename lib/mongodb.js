...
module.exports = (function(mongo) {
    ...
    function getDBObject(o) {
        return BSON.to(o);
    }
    function queryOrID(query) {
        if (typeof query === 'object') {
            return getDBObject(query);
        } else {
            return getDBObject({ _id: query });
        }
    }
    ...
    javaExtend(mongo.MongoCollection, {
        ...
        findOne: function(query, fields, orderBy) {
            var args = removeTrailingNulls([
                ...
                fields ? fieldsToObject(fields) : null,
                orderBy ? fieldsToObject(orderBy) : null
            ]);
        ...
        insert: function(obj) {
            obj = Array.isArray(obj) ?
                    obj.map(function(doc) { return BSON.to(doc); })
                    : BSON.to(obj);
        ...
        save: function(obj) {
            return this.__javaObj.save(BSON.to(obj));
        },
        toString: function() {
            return "[MongoCollection: " + this.name + "]";
        },
        update: function(query, obj) {
            return this.__javaObj.update(BSON.to(query), BSON.to(obj));
        },
    });
